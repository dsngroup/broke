...
public final class MqttMessageFactory {
    ...
    public static MqttMessage newMessage(MqttFixedHeader mqttFixedHeader, Object variableHeader, Object payload) {
        switch (mqttFixedHeader.messageType()) {
            ...
            case PINGREQ:
                return new MqttPingReqMessage(mqttFixedHeader, (MqttPingReqVariableHeader) variableHeader);
            case PINGRESP:
                return new MqttPingRespMessage(mqttFixedHeader, (MqttPingRespVariableHeader) variableHeader);
            case DISCONNECT:
